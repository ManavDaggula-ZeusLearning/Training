...
CREATE STREAM ENROLLMENT_VALUES(BEFORE STRUCT<USER_ID INT, CLASS_ID INT>, AFTER STRUCT<USER_ID INT, CLASS_ID INT>, OP VARCHAR, TS_MS BIGINT) WITH (KAFKA_TOPIC='dbserver1.kafkadb.enrollment', VALUE_FORMAT='JSON');
